...
def read_line():
	...
	line_buffer = []
	while True:
		next_char = ser.read(1)								#read a single character over serial
		if next_char == '':									#if returns empty, quit
			break
		line_buffer.append(next_char)						#add the read char to the line buffer
